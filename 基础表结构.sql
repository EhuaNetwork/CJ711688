...
CREATE TABLE `cj_info`  (
  ...
  `address_info` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '详细地址',
  `shop_info` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '公司简介',
